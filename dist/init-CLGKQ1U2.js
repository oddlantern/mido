...
import { n as loadPlugins, t as PluginRegistry } from "./registry-CaCRUKZr.js";
...
async function runPostInitCheck(parsers) {
	...
	const { buildWorkspaceGraph } = await import("./workspace-22OBPV16.js").then((n) => n.n);
...
async function promptNextSteps(parsers, summary) {
	...
	switch (next) {
		case "dev": {
			...
			const { runDev } = await import("./dev-BzEbc--P.js");
...
async function runReconciliation(root, configPath, parsers) {
	...
	try {
		...
		const { runInit } = await import("./init-CLGKQ1U2.js");
...
//# sourceMappingURL=init-CLGKQ1U2.js.map