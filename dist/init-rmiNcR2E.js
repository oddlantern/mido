...
async function runPostInitCheck(parsers) {
	...
	const { buildWorkspaceGraph } = await import("./workspace-B2H5BXLY.js").then((n) => n.n);
	const { findVersionMismatches } = await import("./versions-CAkFDjVW.js").then((n) => n.r);
	const { loadLock } = await import("./lock-BkASfReh.js").then((n) => n.n);
